...
?>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright <?php echo date('Y');?>. All right reserved.</a></p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
    ...
    <script src="<?php echo ASSETS_PATH ?>js/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="<?php echo ASSETS_PATH ?>js/pie-chart.js"></script>
    <!-- others plugins -->
